        ...
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url(); ?>">
                 <img  src="<?php echo base_url();?>upload/files/images/logo.png" width="150" height="70" alt=""/>
               </a>
            </div>
                ...
                <ul class="nav navbar-nav navbar-right">
                     <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                               <a   href="<?php echo base_url(); ?>currency/set/1"><small>IDR ₺</small> </a> 
                            </li>
                            <li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                            <a   href="<?php echo base_url(); ?>language/set/tr"><small>Indonesia</small> </a> 
                            </li>
                            <li>
