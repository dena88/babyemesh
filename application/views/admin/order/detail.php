...
<table class="table table-striped">
		...
		<tr>
         ...
         <tr>
		           <td>Status</td>
				   <td>
				    <?php if($order_detail->status == "1"){ ?> <p class="bg-info">Waiting</p> <?php } ?>
				    <?php if($order_detail->status == "2"){ ?> <p class="bg-warning">Shipping</p> <?php } ?>
					<?php if($order_detail->status == "3"){ ?> <p class="bg-success">Completed</p> <?php } ?>
					<?php if($order_detail->status == "4"){ ?> <p class="bg-warning">Arrived</p> <?php } ?>
...
<select name="status" class="form-control">
   <option value="<?php echo $order_detail->status; ?>"> 
   				    <?php if($order_detail->status == "1"){ ?> Waiting <?php } ?>
				    <?php if($order_detail->status == "2"){ ?> Shipping <?php } ?>
					<?php if($order_detail->status == "3"){ ?> Completed <?php } ?>
					<?php if($order_detail->status == "4"){ ?> Arrived <?php } ?>
